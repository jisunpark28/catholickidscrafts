...
- **Catholic terminology:** UI copy and Korean notes must use Catholic book names (`src/lib/bible/catholic-book-names.ts`) — e.g. **마르코** (not 개신교식 “마가”), **마태오**, **탈출기**, 73-book canon. Scripture text from the API stays Douay-Rheims English.

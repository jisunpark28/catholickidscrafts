...
const EN = {
  ...
  ruth: "Ruth stays loyal to Naomi and later becomes an ancestor of David.",
  ...
  "1-paralipomenon": "Genealogies and David's Temple worship and prayer.",
  ...
  ecclesiasticus: "Sirach teaches wisdom for family, liturgy, and daily life.",
  ...
  romans: "Paul explains how we are made righteous in Christ and live in the Holy Spirit.",
  "1-corinthians": "Paul teaches unity, love, and worthy celebration of the Eucharist.",
  "2-corinthians": "Paul defends his ministry and God's power in weakness.",
  galatians: "Paul proclaims freedom in Christ against a distorted gospel.",
  ...
  colossians: "Christ is first in all things; the faithful are called to holy living.",
  "1-thessalonians": "Paul encourages hope in Christ's Second Coming and holy living.",
  ...
  "2-timothy": "Paul charges Timothy to proclaim the word with courage.",
  ...
  "2-peter": "Peter warns against false teachers and affirms Christ's Second Coming.",
  "1-john": "John teaches that God is love and calls the faithful to communion.",
  ...
  jude: "Jude exhorts the faithful to hold fast to the faith once delivered.",
  apocalypse: "John sees Christ's victory and the wedding feast of the Lamb.",
};

const KO = {
  genesis: "하느님께서 천지를 창조하시고 아브라함과 계약을 시작하십니다.",
  exodus: "하느님께서 이스라엘을 이집트에서 해방하시고 시나이에서 십계명을 주십니다.",
  leviticus: "이스라엘이 거룩한 백성으로 하느님을 섬기며 살 길을 배웁니다.",
  ...
  ruth: "룻은 나오미를 떠나지 않고, 나중에 다윗의 조상이 됩니다.",
  ...
  "1-paralipomenon": "족보와 다윗 왕의 전례와 기도가 기록됩니다.",
  "2-paralipomenon": "솔로몬의 성전과 유다 왕들의 신앙이 다뤄집니다.",
  "1-esdras": "유배에서 돌아온 이들이 예루살렘 성전을 재건합니다.",
  "2-esdras-nehemias": "느헤미야가 성벽을 재건하고 계약을 새롭게 합니다.",
  tobias: "토빗과 토비아는 신앙과 가족 사랑으로 하느님의 인도를 경험합니다.",
  judith: "유딧은 용기와 신뢰로 백성을 구합니다.",
  esther: "에스테르는 민족을 구하기 위해 목숨을 걸습니다.",
  job: "욥은 고난 속에서 하느님의 지혜를 만납니다.",
  psalms: "찬미와 탄원, 신뢰의 기도와 노래 모음입니다.",
  proverbs: "주님을 경외하며 사는 실천적 지혜를 가르칩니다.",
  ecclesiastes: "하느님 주권 아래 인생의 의미를 묻습니다.",
  "canticle-of-canticles": "결혼 사랑의 노래로 하느님 사랑을 비춥니다.",
  wisdom: "지혜는 생명과 하느님과의 우정으로 이끕니다.",
  ecclesiasticus: "집회서는 가정, 전례, 일상의 지혜를 가르칩니다.",
  isaias: "이사야는 메시아와 새 창조의 희망을 선포합니다.",
  jeremias: "예레미야는 회개를 촉구하고 새 계약을 약속합니다.",
  ...
  romans: "바오로는 신앙으로 의롭게 됨과 성령 안의 삶을 설명합니다.",
  "1-corinthians": "바오로는 일치, 사랑, 합당한 성찬례를 가르칩니다.",
  ...
  colossians: "그리스도께서는 만물의 으뜸이시며 거룩한 삶이 요청됩니다.",
  "1-thessalonians": "주님께서 다시 오심의 희망과 거룩한 삶을 격려합니다.",
  ...
  hebrews: "예수님은 새 계약의 완전한 대사제이십니다.",
  james: "신앙은 자비와 절제의 행동으로 드러나야 합니다.",

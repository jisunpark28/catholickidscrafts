...
export const PRAYER_CATALOG: PrayerCatalogEntry[] = [
  ...
  { slug: "prayer-to-st-michael", categoryId: "daily", sortOrder: 7 },
  ...
  { slug: "prayer-of-st-francis", categoryId: "devotional", sortOrder: 2 },
  { slug: "eternal-rest", categoryId: "devotional", sortOrder: 3 },
  { slug: "sub-tuum", categoryId: "devotional", sortOrder: 4 },
];

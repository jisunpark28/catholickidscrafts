...
export const SITE_COPY_DEFAULTS: SiteCopySeed[] = [
  ...
  sc("game.tiny_priest.courtyard.bulletin_gospel", "Today's Gospel is {title}.", "game_tiny_priest"),
  ...
  sc(
    ...
    "It is {season} in the Church year.",
    "game_tiny_priest",
  ),
  sc(
    "game.tiny_priest.courtyard.bulletin_done",
  ...
  sc("game.tiny_priest.courtyard.encourage_bulletin", "You read the bulletin ✓", "game_tiny_priest"),
